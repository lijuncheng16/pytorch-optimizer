...
class Net(nn.Module):
    def __init__(self):
        ...
        # 需要修改conv2d, dropout, linear里面所有参数加上fakeQuantize
...
def main():
    conf = Config()
    log_dir = 'runs/mnist_quant_debug_optim'
    ...
    with SummaryWriter(log_dir) as writer:
        ...
        writer.add_graph(model.cuda(), images.cuda())

        # custom optimizer from torch_optimizer package
        optimizer = optim.Quant(model.parameters(), lr=conf.lr)
